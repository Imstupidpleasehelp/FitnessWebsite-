...
class Testimonials extends React.Component {
  render() {
    ...
    <Carousel>
      ...
      <img alt="a" className="testimonial-image" src="http://placehold.it/1000x400/ffffff/c0392b/&text=slide1"  /> </div>
      <div className="testimonialtext">
        <h4>"Skyler helped me reach a PR for my Sprint race and Ironman 70.3. I had over a 1 hour improvement for the Ironman 70.3 race. She would jump in and swim, run, or bike with me and not just tell me what to do. She believed in me more than I did which made me push even harder.  She is very positive, patient, and knows when she needs to be tough. I would highly recommend her as a coach!"
        ...
        <div>
        <div className="testimonial-image-box">
      <img alt="a" className="testimonial-image" src="http://placehold.it/1000x400/ffffff/c0392b/&text=slide2"  /> </div>
        ...
        <div>
        <div className="testimonial-image-box">
      <img alt="a" className="testimonial-image" src="http://placehold.it/1000x400/ffffff/c0392b/&text=slide3"  /> </div>
